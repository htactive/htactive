...
jQuery(document).ready(function($) {
		...
		if (!($.cookie('stylesheet'))) {
			...
			link.attr('href','/assets/voc/css/skins/' + stylesheet + '.css');
			$('.style-switcher .styleChange li[data-style="'+stylesheet+'"]').addClass("selected");
			if ($(".header-page-dark").length>0) {
				document.getElementById("logo").src="/assets/voc/images/logo_dark_header_" + stylesheet + ".png";
			} else {
				document.getElementById("logo").src="/assets/voc/images/logo_" + stylesheet + ".png";
			};
		};
