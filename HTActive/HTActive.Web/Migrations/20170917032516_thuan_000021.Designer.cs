...
namespace HTActive.Web.Migrations
{
    ...
    [Migration("20170917032516_thuan_000021")]
    partial class thuan_000021
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HTActive.Entities.ContentNews", b =>
                {
                    ...
                    b.Property<string>("RelatedText")
                        .HasMaxLength(512);

                    b.Property<string>("ShareThisText")
                        .HasMaxLength(512);
            ...
            modelBuilder.Entity("HTActive.Entities.NewsRelatedNews", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<int?>("CurrentNewsId");
            ...
            modelBuilder.Entity("HTActive.Entities.NewsRelatedNews", b =>
                {
                    b.HasOne("HTActive.Entities.News", "CurrentNews")
                        .WithMany("CurrentNewsRelatedNewses")
                        .HasForeignKey("CurrentNewsId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("HTActive.Entities.News", "RelatedNews")
                        .WithMany("RelatedNewsRelatedNewses")
